/**
 * Fixture that tests the `useInput` hook with a wide range of key combinations.
 *
 * It exits the app when specific inputs are received, and throws an error
 * otherwise.
 */
...
const { waitUntilExit } = render(<UserInput test={process.argv[2]} />);
